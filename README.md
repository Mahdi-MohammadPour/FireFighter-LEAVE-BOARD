...
## آخرین تغییرات
- مرخصی روزانه: انتخاب ۱ تا ۷ روز؛ هر روز ۳ ساعت از سهمیه ماهانه ۲۱ ساعته مصرف می‌کند.
- مرخصی ساعتی: فقط ۱ ساعت یا ۲ ساعت؛ انتخاب دقیقه حذف شده است.
- تاریخ شروع/پایان روزانه بر اساس روز تقویمی محاسبه می‌شود و در نمایش فقط تاریخ نشان داده می‌شود.
- کارت اعضا مقدار مصرف و باقی‌مانده سهمیه را جداگانه نمایش می‌دهد.
